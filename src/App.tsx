...
const projects = [
  ...
  },
  {
    ...
    aboutKo: "2026년 5월 8일 어버이날, EBS TV와 YouTube를 통해 방영된 어버이날 ID 영상의 일러스트를 제작했습니다. 가족과 함께하는 순간들 속에 L.O.V.E 글자가 자연스럽게 스며들도록 그렸습니다. 담아두었던 LOVE를 꺼내보는 하루 되세요🌸 Happy Parents’ Day!",
  },
  {
    id: 3,
