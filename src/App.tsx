...
const projects = [
  ...
  },
  {
    ...
    gallery: [
      "/project-20-gallery-1.png",
      "/project-20-gallery-2.png",
      "/project-20-gallery-3.png",
      "/project-20-gallery-4.png",
      "/project-20-gallery-5.png",
      "/project-20-gallery-6.png",
    ],
    size: "small",
    year: "2026",
    client: "EBS",
    projectType: "Broadcast ID Illustration",
    aboutEn: "I created the illustrations for EBS’s Parents’ Day ID, which aired on EBS TV and YouTube on May 8, 2026. The letters L.O.V.E are naturally woven into moments shared with family. May today be a day to share the LOVE you’ve been holding in your heart. 🌸 Happy Parents’ Day!",
    aboutKo: "2026년 5월 8일 어버이날, EBS TV와 YouTube를 통해 방영된 어버이날 ID 영상의 일러스트를 제작했습니다. 가족과 함께하는 순간들 속에 L.O.V.E 글자가 자연스럽게 스며들도록 그렸습니다. 마음속에 담아두었던 사랑을 꺼내 전하는 하루가 되기를 바랍니다.🌸",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: "부산,경남,울산 홍보 북커버 일러스트레이션 / Book Cover Illustration",
  ...
  },
  {
    ...
    description: "가장 젊은날의 철학 북커버 일러스트레이션 / Book Cover Illustration",
  ...
  },
  {
    ...
    description: "메가공무원 1타강사 조태정 영어 북커버 일러스트레이션 / Book Cover Illustration",
    ...
    gallery: [
      ...
      "/project-17-gallery-5.jpg",
      "/project-17-gallery-6.jpg",
    ],
    size: "small",
    year: "2024",
    client: "NEXT STUDY",
    projectType: "BOOK COVER ILLUSTRATION",
    aboutEn: "I created cover illustrations for five English study books by Mega Civil Service. Each cover features playful lines and objects inspired by the theme of each book, creating a cohesive visual flow throughout the series.",
    aboutKo: "메가공무원 조태정 영어 교재 5종의 표지 일러스트를 그렸습니다. 각 교재의 특징을 다양한 오브제와 경쾌한 선으로 표현해, 시리즈가 하나의 흐름으로 이어지도록 구성했습니다.",
  },
  {
    id: 18,
    title: "Stoic at Work",
    description: "일하는 사람을 위한 철학 북커버 일러스트레이션 / Book Cover Illustration",
    image: "/project-18.jpg",
    detailImage: "/project-18.jpg",
    gallery: [
      "/project-18-gallery-1.jpg",
      "/project-18-gallery-2.jpg",
    ],
    size: "small",
    year: "2024",
    client: "FRONT PAGE",
